...
Foram utilizados 5 vídeos diferentes, e os respectivos vídeos degradados,  obtidos em \cite{}. Os resultados das comparações se encontram nas tabelas \ref{res:mse}, \ref{res:psnr} e \ref{res:mssim}.
...
O número de artefados em cada frame obtido a partir desta configuração é apresentado na figura \ref{fig:histogram}.
