...
\titulo{\MakeUppercase{SASQV2: Ambiente de adição controlada de artefatos e avaliação de vídeos digitais}} % titulo do trabalho em portugues
\title{\MakeUppercase{SASQV2: A controlled artifact addition and digital video assessment environment}} % titulo do trabalho em ingles
...
\keywords{digital video, artificial artifact generation, video quality assessment, subjective assessment, objective assessment} % palavras-chave do trabalho em ingles
