...
As fases da apresentação \sigla{DSCQS}{Double Stimiulus Continuous Quality Scale} podem ser observadas na Figura \ref{fig:dscqsfases}. Elas são semelhantes as fases do método DSIS, a diferença está no momento em que a avaliação é permitida. 
