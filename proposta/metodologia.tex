...
O desenvolvimento do presente trabalho consistirá em 6 fases, resumidas na Tabela \ref{tab:metodologia}. Cada fase consiste em algumas atividades que podem ser realizadas de forma paralela, pois são independentes.

Na fase 1 serão realizadas duas atividades fundamentais: compreender os conceitos envolvidos na avaliação, compressão, transmissão e codificação de vídeos e também a análise do \emph{software}
...
A fase 3 consiste do desenvolvimento em paralelo das ferramentas de degradação e da interface gráfica. Buscando reaproveitar e readequar o SASQV se optou por utilizar a mesma
linguagem de programação: Java. Também é considerada a possibilidade de desenvolver as ferramentas em linguagem C++, por apresentar um desempenho levemente superior 
e possuir uma vasta gama de ferramentas de vídeo comparável à disponível em Java. O controle de versão será efetuado por meio da ferramenta Git, o que também possibilita a utilização do 
serviço GitHub, uma ferramenta de desenvolvimento colaborativo que diponibiliza repositórios de código gratuitos.

O teste e validação das ferramentas será efetuado na fase 4 do projeto. ?? não sei mais o q colocar aqui??
Assim que terminada a fase 4 será feita a integração entre as ferramentas e a interface, gerando uma única ferramenta ao final.

Por fim, a fase 6 se utilizará de uma base de vídeos de referência, ainda a ser escolhida, e da ferramenta desenvolvida para produzir uma base de vídeos degradados. 
...
Também será parte do trabalho avaliar a magnitude do impacto das diversas degradações obtidas ao se avaliar os vídeos degradados por métricas objetivas.
